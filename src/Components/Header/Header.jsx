...
function Header() {
  ...
  const agentMainPages = [
    { label: t("pages.propertyListings"), path: '/agentlisting' },

    { label: t("pages.aboutUs"), path: '/' },
    { label: t("pages.contact"), path: '/' },
  ];
  ...
  const buyerMainPages = [
    { label: t("pages.propertyListings"), path: '/buyerdetailspage' },
    { label: t("pages.aboutUs"), path: '/' },
    { label: t("pages.contact"), path: '/' },
  ];
  ...
  const sellerMainPages = [
    { label: t("pages.propertyListings"), path: '/sellers' },
    { label: t("pages.aboutUs"), path: '/' },
    { label: t("pages.contact"), path: '/' },
  ];
